...
class AgreementService(
    ...
    fun createAgreement(organization: String, logo: String, agreementNumber: Long): String {
        val htmlContent: String = generateAgreementHtml(organization, logo, agreementNumber)
        return filesystemService.saveHtmlContentAsPdf(htmlContent)
    }

    private fun generateAgreementHtml(organization: String, logo: String, agreementNumber: Long): String {
        val context = Context()
